...
const Login: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto py-12 px-4">
      <h1 className="text-3xl font-extrabold text-claret mb-8 text-center font-poppins drop-shadow-lg">Login to Your Account</h1>
      ...
      <div className="bg-darkpurple rounded-2xl shadow-lg p-8">
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-white/80">
            ...
            <Link to="/signup" className="text-claret hover:text-white font-bold">
              Sign up here
            </Link>
          </p>
        </div>
